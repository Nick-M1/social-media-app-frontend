export default function RightSidebarComponent() {
    return (
        <aside className="position-relative ">
            <section className="overflow-y-auto fixed h-screen no-scrollbar">
                ...
                <div className="relative text-gray-300 w-80 p-5">
                    ...
                    <input type="search" name="search" placeholder="Search Twitter" className=" bg-dim-700 h-10 px-10 pr-5 w-full text-sm focus:outline focus:outline-white/10 bg-white/10 hover:shadow-md hover:shadow-white/5 focus:shadow-lg focus:shadow-white/5 rounded-xl border border-white/5 smooth-transition"/>
                </div>
